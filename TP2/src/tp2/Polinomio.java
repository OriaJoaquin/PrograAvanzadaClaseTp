...
public class Polinomio {
	...
	public static void main(String[] args) {
		...
		Polinomio [] vecPolinomio = new Polinomio[18];

		//vecPolinomio[0] = new Polinomio(1, new double[]{1,2});
		vecPolinomio[0] = new Polinomio(2, new double[]{1,2,5});
		vecPolinomio[1] = new Polinomio(3, new double[]{1,2,5,2});
		vecPolinomio[2] = new Polinomio(4, new double[]{1,2,5,2,6});
		vecPolinomio[3] = new Polinomio(5, new double[]{1,2,5,2,6,8});
		vecPolinomio[4] = new Polinomio(6, new double[]{1,2,5,2,6,8,3});
		vecPolinomio[5] = new Polinomio(7, new double[]{1,2,5,2,6,8,3,7});
		vecPolinomio[6] = new Polinomio(8, new double[]{1,2,5,2,6,8,3,7,9});
		vecPolinomio[7] = new Polinomio(9, new double[]{1,2,5,2,6,8,3,7,9,0});
		vecPolinomio[8] = new Polinomio(10, new double[]{1,2,5,2,6,8,3,7,9,0,1});
		vecPolinomio[9] = new Polinomio(20, llenarVector(20));
		vecPolinomio[10] = new Polinomio(30, llenarVector(30));
		vecPolinomio[11] = new Polinomio(40, llenarVector(40));
		vecPolinomio[12] = new Polinomio(50, llenarVector(50));
		vecPolinomio[13] = new Polinomio(60, llenarVector(60));
		vecPolinomio[14] = new Polinomio(70, llenarVector(70));
		vecPolinomio[15] = new Polinomio(80, llenarVector(80));
		vecPolinomio[16] = new Polinomio(90, llenarVector(90));
		vecPolinomio[17] = new Polinomio(200, llenarVector(200));
